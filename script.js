        ...
        div.innerHTML = `
          ...
          <div class="article-details">
            ...
            <div class="details">
              ...
              <br>
              ${produit.prix && produit.prix.trim() !== '' ? `
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  logo.addEventListener('touchstart', () => {
    ...
    if (tapCount === 3) {
      ...
      fetch('https://script.google.com/macros/s/AKfycbyRHCuLb0IC_fLpQs36UW_zzgnwmDHAJtDZHByZjz3rxHieXr-Xw54yt5NvCEZgzk64xQ/exec?page=popupWelcome')
